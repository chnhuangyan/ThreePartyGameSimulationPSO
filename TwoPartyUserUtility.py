...
# Sr=[1, 1, 0.8706466267487871]
# Sh=[1, 0.8294145254499943, 0.6966821940060461]
# Sg=[0.8262510141812147, 0.6649370542641709, 0.4971265653840268]
# Sf=[0.5508707910032993, 0.4719810515096373, 0.4329008260712299]
...
for k in g:
    ...
    Up1[k] = data.lambd * sumquadra-(1-b)*sumc-b*sums1
    Up2[k] =data.lambd * sumquadra-(1-b)*sumc-b*sums2
    Up3[k] = data.lambd * sumquadra-sumc
# for i in g:
...
plt.plot(g, Up3, 'o-.', color="r", ms=8, markerfacecolor='none',  label="Trusted Platform")
#plt.savefig('na VS delta')

plt.xlabel('User\'s strategy $G$', fontsize=12)
plt.ylabel('User\'s utility $U_p$', fontsize=12)
